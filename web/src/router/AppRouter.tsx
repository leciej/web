  ...
  return (
    <Routes>
      <Route element={<AppLayout />}>
        ...
        <Route path="/user/products/:id" element={<UserProductDetailsPage />} />
        <Route path="/user/gallery" element={<UserGalleryPage />} />
        <Route path="/user/gallery/:id" element={<UserGalleryDetailsPage />} />

        {/* ADMIN */}
        <Route path="/admin/dashboard" element={<AdminDashboardPage />} />
        <Route path="/admin/profile" element={<AdminProfilePage />} />
        <Route path="/admin/products" element={<AdminProductsPage />} />
        <Route path="/admin/products/add" element={<AdminAddEditProductPage />} />
        <Route path="/admin/products/edit/:id" element={<AdminAddEditProductPage />} />
        <Route path="/admin/gallery" element={<AdminGalleryPage />} />
        <Route path="/admin/gallery/add" element={<AdminAddEditGalleryPage />} />
        <Route path="/admin/gallery/edit/:id" element={<AdminAddEditGalleryPage />} />
